  ...
  return (
    <header className="sticky top-0 z-50 grid grid-cols-3 shadow-md p-5 bg-white md:px-10">
      ...
      <div className="flex items-center md:border-2 rounded-full p-2 md:shadow-sm">
          <input className='pl-2 flex-grow outline-none text-sm text-gray-900 placeholder-gray-900' type="text" placeholder="Start your search" />
          <SearchIcon className='h-8 hidden md:inline-flex bg-red-400 text-white p-2 rounded-full cursor-pointer' />
      </div>
      <div className="flex items-center justify-end space-x-4">
          <p className='font-bold hidden md:inline-flex cursor-pointer'>Become a Host</p>
